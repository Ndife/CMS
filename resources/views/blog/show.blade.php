...
@section('header')
   <!-- Header -->
   <header class="header text-white h-fullscreen pb-80" style="background-image: url({{ asset('uploads/posts/' . $post->image) }})" data-overlay="9">
    <div class="container text-center">
      ...
      <div class="row h-100">
        <div class="col-lg-8 mx-auto align-self-center">
          ...
          <p><img class="avatar avatar-sm" src="http://www.gravatar.com/avatar/?d=identicon" alt="..."></p>
            ...
            <div class="container">
                ...
                <script>
                    ...
                    *  LEARN WHY DEFINING THESE VARIABLES IS IMPORTANT: https://disqus.com/admin/universalcode/#configuration-variables*/
                    ...
                    s.src = 'https://sass-blog-tapxuoegix.disqus.com/embed.js';
